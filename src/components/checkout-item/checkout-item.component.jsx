...
const CheckoutItem = ({cartItem, clearItem,addItem,removeItem}) => {
    ...
    <div className='checkout-item'>
        ...
        <span className='quantity'><i onClick={()=>removeItem(cartItem)} class="fa fa-minus" aria-hidden="true"></i>{quantity}<i  onClick={()=> addItem(cartItem)} class="fa fa-plus" aria-hidden="true"></i></span>
